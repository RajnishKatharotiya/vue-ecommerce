                        ...
                        <div class="row g-2">
                            <div v-if="!isSubmitted">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" v-model="product.name" id="productName" placeholder="" required />
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" id="productDescription" placeholder="" v-model="product.description"></textarea>
                                    <div class="invalid-feedback">Valid description</div>
                                </div>
                                <div class="col-12">
                                    <label for="productType" class="form-label">Product Type</label>
                                    <select class="form-control" id="productType" placeholder="" required v-model="product.type">
                            ...
                            <div v-else >
                                ...
                                <button class="w-100 btn btn-success btn-lg mt-3" type="button" @onClick="reset" >New product </button>
                            </div>
                            <hr class="my-4">
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        async saveProduct(){
            try{
                await ProductDataService.add(this.product); 
                this.isSubmittedType = 'success';
                this.submitMessage = "You submitted successfully!";
            } catch(E){
                this.isSubmittedType = 'errror';
